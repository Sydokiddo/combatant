...
import net.sydokiddo.combatant.registry.enchantment.enchantments.StompingEnchantment;
...
public class ModEnchantments extends Enchantments {
    ...
    public static Enchantment STOMPING = register("stomping",
    new StompingEnchantment(Enchantment.Rarity.RARE, EnchantmentCategory.ARMOR_FEET));
